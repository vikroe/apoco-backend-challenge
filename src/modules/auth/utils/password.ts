...
type ScryptAsync = (password: string, salt: string, keyLength: number) => Promise<Buffer>;
...
export const verifyPassword = async (password: string, hashToCompare: string): Promise<boolean> => {
